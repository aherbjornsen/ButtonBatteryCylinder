  ...
  e = 0.02;
	...
	if (Render_cover) {
		difference () {
			...
			// Add text, rotate it to thickest part of cover
			rotate([0,0,90]) text_on_cylinder(t=Cover_text,r=Cover_D/2-Wall_width/4,h=Cover_X, extrusion_height=Wall_width/2,size=Cover_font_size);
		}
	}
}

/* 
Everything from here on down is a copy of the text_on library from https://github.com/brodykenrick/text_on_OpenSCAD

See this link for licensing information and updates.

To use a different version of this library, cut everything from here to the bottom, and add approriate "use" statement at top of file.
*/
